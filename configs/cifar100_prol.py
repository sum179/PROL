...
def get_args_parser(subparsers):
    subparsers.add_argument('--batch-size', default=10, type=int, help='Batch size per device')
    ...
    subparsers.add_argument('--top_k_l', default=1, type=int, )
    ...
    subparsers.add_argument('--intertask_coeff', default=0.001, type=float)
    ...
    subparsers.add_argument('--lrcos_etamin', default=0.0005, type=float)
    subparsers.add_argument('--lrcos_tmax', default=20, type=int)
    subparsers.add_argument('--lrrat', default=0.0005, type=float)
    subparsers.add_argument('--loss_thres', default=0.3, type=float)

    subparsers.add_argument('--dist_coeff', default=0.01, type=float)
    subparsers.add_argument('--dist_T', default=1.0, type=float)
